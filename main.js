...
function myKeyDown(e) {
    ...
    function left() {
        if (ballX > 0) {
            ...
            console.log("lagura da imagem do bloco = " + blockImageWidth)
    ...
    function right() {
        if (ballX < 1050) {
            ballX = ballX + blockImageWidth
            console.log("lagura da imagem do bloco = " + blockImageWidth)
            console.log("Quando a tecla dircional Direita for pressionada, X = " + ballX + ", Y = " + ballY)
            canvas.remove(ballObj)
            newImage()
        }
    }
    ...
    function down() {
        if (ballY < 450) {
            ballY = ballY + blockImageHeight
            console.log("altura da imagem do bloco = " + blockImageHeight)
            console.log("Quando a tecla dircional Baixo for pressionada, X = " + ballX + ", Y = " + ballY)
            canvas.remove(ballObj)
            newImage()
        }
    }
